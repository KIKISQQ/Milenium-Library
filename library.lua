...
-- Library init
    ...
    flags["Name_Color"] = {Color = rgb(255, 255, 255), Transparency = 0} 
    flags["Distance_Color"] = {Color = rgb(255, 255, 255), Transparency = 0}
    flags["Weapon_Color"] = {Color = rgb(255, 255, 255), Transparency = 0}
    ...
    -- Misc functions
        ...
        function library:load_config(config_json) 
            ...
            for _, v in config do  
                ...
                local function_set = library.config_flags[_]
                if function_set and not (type(v) == "table" and v["Transparency"] and v["Color"]) then
    ...
    -- Library element functions
        ...
        function library:toggle(options) 
            local cfg = {
                ...
                type = options.type and "checkbox"; -- "toggle", "checkbox"
        ...
        function library:viewport(properties)
        ...
        function library:esp_preview(properties)
            ...
            local objects = cfg.objects; do 
                ...
                objects[ "name" ] = library:create( "TextLabel" , {
                    ...
                    BorderColor3 = rgb(0, 0, 0);
                    Text = string.format("%s (@%s)", "Melkari", lp.Name);
                    Name = "\0";
                ...
                -- Mana bar
                objects[ "manabar_holder" ] = library:create( "Frame" , {
                ...
                objects[ "manabar" ] = library:create( "Frame" , {
                    Parent = objects[ "manabar_holder" ];
                    Name = "\0";
                    Position = dim2(0, 1, 0, 1);
                    BorderColor3 = rgb(0, 0, 0);
                    Size = dim2(1, -2, 1, -2);
                    BorderSizePixel = 0;
                    BackgroundColor3 = rgb(0, 162, 255) 
                });
                
                --hunger bar
                objects[ "hungerbar_holder" ] = library:create( "Frame" , {
                    AnchorPoint = vec2(0, 0);
                    Parent = library.cache;
                    Name = "\0";
                    Position = dim2(1, 1, 0, 0);
                ...
                objects[ "hungerbar" ] = library:create( "Frame" , {
                    Parent = objects[ "hungerbar_holder" ];
                    Name = "\0";
                    Position = dim2(0, 1, 0, 1);
                    BorderColor3 = rgb(0, 0, 0);
                    Size = dim2(1, -2, 1, -2);
                    BorderSizePixel = 0;
                    BackgroundColor3 = rgb(255, 166, 0) 
                });
            ...
            function cfg.refresh_elements( )                                
                ...
                local temp = {
                    ...
                    ["Mana"] = objects["manabar_holder"];
                    ["Hunger"] = objects["hungerbar_holder"];
            ...
            cfg.change_mana = function()
                if not EspSettings["Manabar"] then
                    objects["manabar_holder"].Visible = false
                    return
                else
                    objects["manabar_holder"].Visible = true
                end
            
                if flags["manabar_holder"] and flags["manabar_holder"].Parent ~= objects["holder"] then 
                    return 
                end
            
                local multiplier = math.abs(math.sin(tick() * 2))
            
                objects["manabar"].Size = UDim2.new(1, -2, multiplier, -2)
                objects["manabar"].Position = UDim2.new(0, 1, 1 - multiplier, 1)
                objects["manabar"].BackgroundColor3 = flags["Mana"].Color
            end

            cfg.change_hunger = function()
                if not EspSettings["HungerBar"] then
                    objects["hungerbar_holder"].Visible = false
                    return
                else
                    objects["hungerbar_holder"].Visible = true
                end
            
                if flags["hungerbar_holder"] and flags["hungerbar_holder"].Parent ~= objects["holder"] then 
                    return 
                end
            
                local multiplier = math.abs(math.sin(tick() * 2))
            
                objects["hungerbar"].Size = UDim2.new(1, -2, multiplier, -2)
                objects["hungerbar"].Position = UDim2.new(0, 1, 1 - multiplier, 1)
            end
